...
import com.focustech.message.model.LoginRsp;
import com.focustech.message.model.MessageBean;
import com.focustech.message.model.ReceptNty;
...
import com.focustech.message.params.SystemMsgType;
...
public class MTMessageHandlerAdapter implements IMessageHandler {
	...
	public void onGroupsInfoRsp(TMMessage message) {
		try {
			...
			for (Group.MyGroupInfoRsp myGroupInfoRsp : myGroupInfoRspList) {
				com.focustech.message.model.Group.parse(myGroupInfoRsp);
			}
		} catch (InvalidProtocolBufferException e) {
			e.printStackTrace();
		}
	...
	public void onMyGroupInfoRsp(TMMessage message) {
		try {
			...
			com.focustech.message.model.Group group = com.focustech.message.model.Group.parse(rsp);
		} catch (InvalidProtocolBufferException e) {
			e.printStackTrace();
		}
	}
