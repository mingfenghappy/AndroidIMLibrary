...
public class NetConnector {
	...
	private void initConnector() {
		...
		connector.addListener(new IoServiceListener() {
			...
			public void serviceIdle(IoService arg0, IdleStatus arg1) throws Exception {
				Log.d("NetConnector", "客户端进入空闲状态...");
			}

			@Override
			public void serviceDeactivated(IoService arg0) throws Exception {
				Log.d("NetConnector", "服务被停用");
			}

			@Override
			public void serviceActivated(IoService arg0) throws Exception {
				Log.d("NetConnector", "服务被激活");
			}
		});
	}
	...
	public boolean connect() {
		...
		initConnector();
		Log.d("NetConnector", "开始连接:"+currentServer.toString());
		// 开始连接
		...
		Log.d("NetConnector", "连接状态:"+ (isConnected ? "connected" : "disconnected"));
		if (isConnected) {
